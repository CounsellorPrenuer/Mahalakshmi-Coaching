        ...
        <section className="py-16 bg-gradient-to-br from-primary/10 to-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto text-center">
              Read testimonials from professionals who have experienced transformative growth with Mahalakshmi Coaching.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {testimonials.map((testimonial) => (
                <Card
                  key={testimonial._id}
                  className="transition-all border-l-4 border-l-primary"
